...
export async function createStory(data) {
  ...
  const s = {
    ...
    previewVideoUrl: data.previewVideoUrl || data.preview_video_url || undefined,
...
export async function updateStory(id, data) {
  ...
  const s = {
    ...
    previewVideoUrl: data.previewVideoUrl ?? data.preview_video_url ?? existing.previewVideoUrl,
